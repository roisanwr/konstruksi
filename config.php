...
define('DB_USER', 'root');              // Ganti dengan username database MySQL kamu.
define('DB_PASS', '');                  // Ganti dengan password database MySQL kamu (kosongkan jika tidak ada).
define('DB_NAME', 'jaya');              // Nama database kita yang sudah kita sepakati!
...
define('BASE_URL', 'http://localhost/proyek_jaya/'); // GANTI SESUAI ALAMAT PROYEKMU!
