...
<body class="bg-white">
    ...
    <section id="services" class="py-20 px-6 lg:px-16">
        <div class="container mx-auto">
            <h2 class="text-3xl md:text-4xl font-bold text-center mb-4 scroll-reveal">Layanan <span class="text-orange-600">Kami</span></h2>
            <p class="text-center text-gray-600 mb-16 max-w-2xl mx-auto scroll-reveal">Solusi lengkap untuk segala kebutuhan proyek dan bisnis Anda.</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="service-card bg-white rounded-lg shadow-md p-8 hover:shadow-xl transition duration-300 scroll-reveal">
                    <div class="bg-orange-100 w-16 h-16 rounded-full flex items-center justify-center mb-6 mx-auto">
                        <i class="fas fa-drafting-compass text-orange-600 text-2xl"></i>
                    </div>
                    <h3 class="text-xl font-semibold mb-3 text-center">Design & Build</h3>
                    <p class="text-gray-700 text-center text-sm">Layanan terintegrasi mulai dari konsep desain hingga pembangunan fisik, memberikan efisiensi dan hasil yang presisi.</p>
                </div>
                ...
                <div class="service-card bg-white rounded-lg shadow-md p-8 hover:shadow-xl transition duration-300 scroll-reveal" style="transition-delay: 0.2s;">
                    ...
                    <h3 class="text-xl font-semibold mb-3 text-center">Jasa Konstruksi</h3>
                    <p class="text-gray-700 text-center text-sm">Mengerjakan berbagai jenis proyek konstruksi dengan standar kualitas dan keamanan tertinggi.</p>
                </div>
